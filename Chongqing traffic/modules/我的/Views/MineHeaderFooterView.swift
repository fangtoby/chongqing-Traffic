...
class MineHeaderFooterView: UITableViewHeaderFooterView {
...
private class TagView: UIView {
    ...
    func createBtn(){
        let margin:CGFloat = (KScreenWidth-30)/3
        ...
        let lineWidth:CGFloat = (KScreenWidth-30)/3
